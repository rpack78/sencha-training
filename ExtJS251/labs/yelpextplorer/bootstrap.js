...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "YelpExtplorer.Application": [],
  "YelpExtplorer.controller.Business": [],
  "YelpExtplorer.controller.Filter": [],
  "YelpExtplorer.controller.Main": [],
  "YelpExtplorer.model.Business": [],
  "YelpExtplorer.model.Category": [],
  "YelpExtplorer.model.School": [],
  "YelpExtplorer.store.Businesses": [],
  "YelpExtplorer.store.Categories": [],
  "YelpExtplorer.store.Schools": [],
  "YelpExtplorer.store.StarCount": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "YelpExtplorer.store.StarCount": [],
  "YelpExtplorer.view.BusinessesGrid": [
    "widget.businessesgrid"
  ],
  "YelpExtplorer.view.BusinessesMap": [
    "widget.businessesmap"
  ],
  "YelpExtplorer.view.BusinessesView": [
    "widget.businessesview"
  ],
  "YelpExtplorer.view.Filter": [
    "widget.filter"
  ],
